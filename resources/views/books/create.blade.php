...
<head>
    ...
    <title>Gellie Anne Costales — Add New Book</title>
...
<div class="hero">
    <div>
        ...
        <div class="hero-title">Add a New Book</div>
        <div class="hero-sub">Fill in the details below to add a new title to your collection.</div>
    </div>
</div>

<main class="content">
    <div class="form-card">
        <div class="form-card-title">Book Details</div>
        <div class="form-card-sub">All fields are required.</div>
        ...
        <form action="{{ route('books.store') }}" method="POST" novalidate>
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('title') is-invalid @enderror" type="text" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. The Great Gatsby" autofocus>
                @error('title')<div class="form-error">{{ $message }}</div>@enderror
            </div>

            <div class="form-group">
                <label class="form-label" for="author">Author</label>
                <input class="form-control @error('author') is-invalid @enderror" type="text" id="author" name="author" value="{{ old('author') }}" placeholder="e.g. F. Scott Fitzgerald">
                @error('author')<div class="form-error">{{ $message }}</div>@enderror
            </div>

            <div class="form-group">
                <label class="form-label" for="published_date">Published Date</label>
                <input class="form-control @error('published_date') is-invalid @enderror" type="date" id="published_date" name="published_date" value="{{ old('published_date') }}">
